      ...
      <div class="connecting-help rounded p-6 flex flex-column">
        <div class="flex">
          ...
          <div class="flex flex-column ml-4">
            <h3>Войдите в лаунчер RAGE MP</h3>
            <span class="opacity-50">В правом верхнем углу лаунчера необходимо нажать на иконку подключения и вписать IP нашего сервера</span>
          </div>
        </div>
