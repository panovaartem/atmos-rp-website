        ...
        <div class="md:w-2/3 w-full" id="component-news">
          ...
          >
            <div id="news-card" class="flex flex-col sm:flex-row mb-5">
              <img
                :src="require(`@/assets/img/news/${item.img}.jpg`)"
                alt=""
                class="rounded"
              />
              <div class="sm:ml-4 sm:mt-0 flex flex-col justify-between">
                <div class="flex flex-col">
                  <span class="uppercase font-bold text-base sm:text-lg">{{
                    item.header
                  }}</span>
                  <span
                    class="opacity-75 mt-1 font-light text-sm sm:text-base"
                    >{{ item.short_discrition }}</span
                  >
                </div>
                <div class="flex items-center mt-2 sm:mt-0">
                  <svg-vue icon="like" style="width: 16px; height: 16px" />
                  <span class="text-sm sm:text-base ml-1">{{
                    item.likes
                  }}</span>
                  <svg-vue
                    icon="date"
          ...
          <div
            id="pagination"
            class="flex mb-5 justify-center md:justify-start"
          >
            <div class="flex">
              <div
              ...
              <div
                id="container-pagination"
                class="rounded flex justify-center items-center ml-3"
              >
                <span>1</span>
              </div>
              <div
